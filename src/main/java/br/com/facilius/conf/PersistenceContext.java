...
@Configuration
@EnableJpaRepositories(basePackages = { "br.com.facilius" })
...
//	The method that configures the datasource bean looks as follows:
	...
	DataSource dataSource(Environment env) {
		...
		DataSource dataSource = dsLookup.getDataSource("jdbc/facilius");
		return dataSource;
	}
...
//	The method that configures the entity manager factory bean looks as follows:
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Environment env) {
		...
		entityManagerFactoryBean.setPackagesToScan("br.com.facilius");
